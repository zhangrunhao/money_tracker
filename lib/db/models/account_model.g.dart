...
const _AccountModeltypeValueEnumMap = {
  r'stored': AccountType.stored,
  r'debt': AccountType.debt,
};
...
extension AccountModelQuerySortBy
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> sortByCreateTime() {
    return QueryBuilder.apply(this, (query) {
...
extension AccountModelQuerySortThenBy
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> thenByCreateTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createTime', Sort.asc);
    });
  }
...
extension AccountModelQueryWhereDistinct
  ...
  QueryBuilder<AccountModel, AccountModel, QDistinct> distinctByCreateTime() {
    return QueryBuilder.apply(this, (query) {
